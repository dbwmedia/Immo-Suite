...
- **Archiv (Listenansicht):** https://immo-suite-demo.dbw-development.de/immobilien/
- **Beispiel-Detailseite:** https://immo-suite-demo.dbw-development.de/immobilien/traumhaft-fuer-familien-einfamilienhaus-in-top-lage/
- **WP-Admin Immobilien:** https://immo-suite-demo.dbw-development.de/wp-admin/edit.php?post_type=immobilie
- **Plugin-Einstellungen:** https://immo-suite-demo.dbw-development.de/wp-admin/edit.php?post_type=immobilie&page=dbw-immo-suite-settings
- **Import-Dashboard:** https://immo-suite-demo.dbw-development.de/wp-admin/edit.php?post_type=immobilie&page=dbw-immo-import
- **Customizer:** https://immo-suite-demo.dbw-development.de/wp-admin/customize.php?return=%2Fwp-admin%2Fedit.php%3Fpost_type%3Dimmobilie%26page%3Ddbw-immo-import
...
- [ ] Oeffne https://immo-suite-demo.dbw-development.de/immobilien/
...
- [ ] Oeffne https://immo-suite-demo.dbw-development.de/immobilien/traumhaft-fuer-familien-einfamilienhaus-in-top-lage/
...
- [ ] Oeffne https://immo-suite-demo.dbw-development.de/wp-admin/edit.php?post_type=immobilie&page=dbw-immo-suite-settings
...
- [ ] Oeffne https://immo-suite-demo.dbw-development.de/wp-admin/edit.php?post_type=immobilie&page=dbw-immo-import
...
## TEIL 9: DSGVO / DATENSCHUTZ

### 9.1 Externe Ressourcen

- [ ] Lade eine Detailseite und pruefe im Network-Tab: Werden externe Ressourcen geladen OHNE vorherige Zustimmung?
- [ ] Leaflet/OpenStreetMap Tiles duerfen NUR geladen werden, wenn der Karten-Consent deaktiviert ist (Customizer) ODER der User auf "Karte laden" klickt
- [ ] Keine Google Fonts, kein Google Maps, kein externes CDN (jQuery, Bootstrap etc.)
- [ ] Keine externen Tracking-Scripts (Analytics, Facebook Pixel etc.) vom Plugin selbst
- [ ] Alle CSS/JS-Dateien kommen vom eigenen Server (Leaflet aus assets/vendor/leaflet/)

### 9.2 Kontaktformular

- [ ] Wird beim Kontaktformular ein Datenschutz-Checkbox angezeigt (Pflichtfeld)?
- [ ] Kann das Formular NICHT abgeschickt werden ohne Checkbox?
- [ ] Ist ein Honeypot-Feld vorhanden (unsichtbar, darf nicht ausgefuellt werden)?
- [ ] Funktioniert das Rate-Limiting? (2x hintereinander absenden → zweites Mal wird blockiert)
- [ ] Werden die eingegebenen Daten NICHT in der Datenbank gespeichert (nur per E-Mail versendet)?
- [ ] Werden keine personenbezogenen Daten in Logfiles geschrieben?

### 9.3 E-Mail-Sicherheit

- [ ] Pruefe im Quellcode: Wird der Name-Feld gegen Header Injection geschuetzt (Newline-Stripping)?
- [ ] Wird die E-Mail an die korrekte Kontaktperson des Objekts gesendet (nicht an eine globale Adresse)?

### 9.4 Cookies

- [ ] Setzt das Plugin eigene Cookies? (Sollte KEINE setzen)
- [ ] localStorage wird nur fuer View-Switcher (grid/list) genutzt — pruefe: `localStorage.getItem('dbw_immo_view')`
- [ ] Keine Session-Cookies, keine Tracking-Cookies vom Plugin

### 9.5 WordPress Privacy API

- [ ] Gehe zu Einstellungen → Datenschutz → Personenbezogene Daten exportieren
- [ ] Wird "Immo Suite" als Datenexporter aufgelistet?
- [ ] Gehe zu Einstellungen → Datenschutz → Personenbezogene Daten loeschen
- [ ] Wird "Immo Suite" als Datenloescher aufgelistet?
- [ ] Beide sollten "Keine Daten gefunden" melden (Plugin speichert keine personenbezogenen Daten)

### 9.6 Karten-Consent (Customizer-Toggle)

- [ ] Oeffne den Customizer → Detailseite → "Karten-Consent anzeigen" ist standardmaessig AUS
- [ ] Bei AUS: Karte wird direkt geladen (kein Placeholder, kein Button)
- [ ] Aktiviere den Toggle → Speichern
- [ ] Bei AN: Consent-Placeholder mit "Karte laden"-Button und Hinweistext wird angezeigt
- [ ] Karte laedt erst NACH Klick auf den Button
- [ ] Der Hinweistext "Dabei werden Daten an OpenStreetMap uebertragen." ist sichtbar

### 9.7 Schema.org / Meta-Tags

- [ ] Pruefe im Quellcode einer Detailseite: Sind personenbezogene Maklerdaten (Name, Telefon) nur im JSON-LD Schema enthalten (gewollt) und nicht in versteckten Meta-Tags?
- [ ] OG-Tags enthalten nur Objektdaten (Titel, Bild, Preis), keine personenbezogenen Daten
